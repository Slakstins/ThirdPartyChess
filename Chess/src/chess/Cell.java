...
public class Cell extends JPanel implements Cloneable {
	...
	// A constructor that takes a cell as argument and returns a new cell will
	// the same data but different reference
	...
	public void setpossibledestination() // Function to highlight a cell to
											// indicate that it is a possible
											// valid move
	{
	...
	public void removepossibledestination() // Remove the cell from the list of
											// possible moves
	{
		this.setBorder(null);
